                        ...
                        <div class="p-5">
                            ...
                            <form id="quickForm" class="user">
                                ...
                                <div class="form-group">
                                    <input type="email" name="eMail" class="form-control form-control-user" id="InputEmail" placeholder="Email Address">
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
    ...
    submitHandler: function () {
      ...
      $.post("<?= base_url('user/singup') ?>",{
        data: data
          ...
          const {id , email} = req
          window.location.href = "<?= base_url('user/emailAuth') ?>"+"?email="+email+"&id="+id
      })
    }
  });
  $('#quickForm').validate({
